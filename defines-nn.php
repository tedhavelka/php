...
// FACTORED IN PHP FILE NAMED 'directory-navigation.php' . . .
    ...
    define("KEY_NAME__DIRECTORY_NAVIGATION__ENTRY_SHOWN", "file_tree_entry_shown__t_f");
    ...
    define("KEY_NAME__DIRECTORY_NAVIGATION__BASE_DIRECTORY_ABBR", "base_dir");
...
//    define("KEY_VALUE__DIRECTORY_NAVIGATION__VIEW_DIRECTORIES_TO_DEPTH_N_ABBR", "dirs-n-deep");
    ...
    define("KEY_VALUE__DIRECTORY_NAVIGATION__VIEW_FILES_IN_GALLERY", "present images in gallery format");
    define("KEY_VALUE__DIRECTORY_NAVIGATION__VIEW_FILES_IN_GALLERY_ABBR", "gallery-format");
...
//----------------------------------------------------------------------
// -- SECTION -- document block level attributes
//----------------------------------------------------------------------
